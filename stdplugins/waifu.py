#imported from ppe-remix to OUB by @heyworld & @DeletedUser420
# and to Uniborg by @Mayur_Karaniya

"""
 `.waifu text` : enjoy your text with anime.
"""
...
#"""Generate random waifu sticker with the text!"""
    ...
    sticcers = await borg.inline_query(
